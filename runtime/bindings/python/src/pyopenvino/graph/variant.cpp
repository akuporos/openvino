...
void regclass_Variant(py::module m)
{
...
template void regclass_VariantWrapper<std::string>(py::module m, std::string typestring);
template void regclass_VariantWrapper<int64_t>(py::module m, std::string typestring);
