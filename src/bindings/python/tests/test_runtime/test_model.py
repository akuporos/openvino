...
def test_serialize_complex_rt_info(request, tmp_path):
    def check_rt_info(model, serialized):
        ...
        # assert model.get_rt_info(bool, ["config", "model_parameters", "labels", "label_tree", "directed"]) == True
        ...
        assert model.get_rt_info(list, ["config", "model_parameters", "mean_values"]) == [22.3, 33.11, 44.0]
